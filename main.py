...
"""
    ...
    summary_template = """
    Given the following {information} about a person I want you to create:
    - A short summary about the person (2-3 sentences)
    - Two interestng facts about the person
    """
